    ...
    headers: async () => [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://js.sentry-cdn.com https://vercel.live https://va.vercel-scripts.com",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
              "img-src 'self' data: blob: https://*.appwrite.io https://cloud.appwrite.io https://*.vercel.app https://vercel.com",
              "font-src 'self' https://fonts.gstatic.com",
              "connect-src 'self' https://*.appwrite.io https://cloud.appwrite.io https://*.sentry.io https://vitals.vercel-insights.com https://va.vercel-scripts.com https://chat.stream.io https://*.stream.io wss://*.stream.io",
