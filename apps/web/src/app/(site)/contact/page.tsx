...
const contactContexts = [
  ...
  },
  {
    ...
    body: "If you want to collaborate, teach, or build with Amar Bhaiya, share your background, the work you want to contribute, and what would make the fit meaningful.",
  },
];
        ...
        <div className="space-y-6">
          ...
          <RetroPanel tone="secondary" size="lg" className="space-y-5">
            ...
            <p className="text-sm font-semibold leading-6 text-foreground/80">
              Good messages usually include your goal, where you are stuck, and what timeline you are working with. For careers or collaborations, include the kind of work you want to contribute.
            </p>
          </RetroPanel>
