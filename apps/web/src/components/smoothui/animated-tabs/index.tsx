...
export default function AnimatedTabs({
  ...
  const getTabStyles = (isActive: boolean) =>
    cn(
      "relative z-10 flex min-h-11 cursor-pointer items-center justify-center gap-2 px-4 py-2 font-sans text-sm font-semibold transition-colors",
  ...
  const getIndicatorStyles = () =>
    cn(
      "absolute",
      variant === "underline" && "right-0 -bottom-px left-0 h-0.5 bg-accent",
      variant === "pill" &&
